...
// Alcance elíptico do goleiro (braços cobrem mais altura que largura)
export const KEEPER_REACH_X = 0.3
export const KEEPER_REACH_Y = 0.48
...
export const DIVE_ANIM_S = 0.3
export const DEFENSE_CHARGE_S = 0.9
export const KEEPER_CLAMP = 0.95
